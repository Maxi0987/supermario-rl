...
class Mario(EntityBase):
    def __init__(
        ...
        self.sound = sound
        self.input = Input(self) if enable_input else None
    ...
    def update(self, action=None, process_input=True):
        ...
        if process_input and self.enable_input and self.input is not None:
    ...
    def apply_action(self, action):
        ...
        self.traits["goTrait"].direction = int(direction)
        self.traits["jumpTrait"].jump(bool(jump))
        self.traits["goTrait"].boost = bool(boost)
